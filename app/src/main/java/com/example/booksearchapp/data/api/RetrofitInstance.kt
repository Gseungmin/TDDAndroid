...
//LAZY를 사용하는 이유: 여러개의 Retrofit 객체가 만들어지면 자원도 낭비되고 통신에 혼선 발생
//따라서 실제 사용되는 순간 단 하나의 인스턴스가 만들어지도록 싱글톤으로 구현
object RetrofitInstance {
    ...
    private val retrofit: Retrofit by lazy {
        ...
        //okHttpClient 인터셉터를 넘겨주어 로그 캣에서 패킷 내용 모니터링
        //OkHttp Core는 서버와 애플리케이션 사이에서 데이터를 인터셉터하는 기능이 있다.
        Retrofit.Builder()
